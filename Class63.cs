...
{
	// Token: 0x06000268 RID: 616 RVA: 0x00004234 File Offset: 0x00002434
	...
	// Token: 0x0600026A RID: 618 RVA: 0x0000427F File Offset: 0x0000247F
	public byte[] method_0(byte[] byte_2)
	{
		return this.method_6(byte_2, true);
	}

	// Token: 0x0600026B RID: 619 RVA: 0x00004289 File Offset: 0x00002489
	public byte[] method_1(byte[] byte_2)
	{
		return this.method_6(byte_2, false);
	}

	// Token: 0x0600026C RID: 620 RVA: 0x00004293 File Offset: 0x00002493
	...
	// Token: 0x0600026D RID: 621 RVA: 0x000042B7 File Offset: 0x000024B7
	private static uint smethod_1(byte[] byte_2)
	{
		return (uint)((int)byte_2[0] << 24 | (int)byte_2[1] << 16 | (int)byte_2[2] << 8 | (int)byte_2[3]);
	}

	// Token: 0x0600026E RID: 622 RVA: 0x000042D0 File Offset: 0x000024D0
	...
	// Token: 0x06000276 RID: 630 RVA: 0x0001640C File Offset: 0x0001460C
